window.onload = function () {
    ...
    // add event listener 
    let buttons = document.querySelectorAll('.quickshop-button');
    buttons.forEach(btn => btn.addEventListener('click', openQuickShop(btn.dataset.handle) ));

    function openQuickShop(handle) {
        console.log(handle);
    }
    // /products/${handle}?view=quickshop&sections=template-product-quickshop
}
