class ProductForm extends HTMLElement {
    ...
    constructor() {
        ...
        this.optionsSelect = document.querySelectorAll('.select-option');
        this.variantJSON = form.querySelector('[data-variantJSON]');
        this.addToCart = document.querySelector('#add-to-cart-btn');

        this.variantSelect = document.querySelector('#variants');
        ...
        this.optionsSelect.forEach(option => {
            option.addEventListener('change', this.variantChange.bind(this));
        })  

        // for color swatch liquid
        // set event listners for color swatch
        this.cs = document.querySelectorAll('.swatch-image');
        this.cs.forEach(li => {
            li.addEventListener('click', this.updateVariant.bind(this));
        })
    ...
    variantChange(e) {
        ...
        this.optionsSelect.forEach((select) => {
            options.push(select.value);
        })
        console.log(options);

        // variant array 
        let variants = JSON.parse(this.variantJSON.textContent);
        ...
        this.variantSelect.value = currentVariant.id;
        this.items.value = currentVariant.id;
